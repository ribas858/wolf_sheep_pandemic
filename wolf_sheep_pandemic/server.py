...
model_params = {
    ...
    "sheep_reproduce": mesa.visualization.Slider(
        "Taxa de Reprodução de Ovelhas", 0.04, 0.0, 1.0, 0.01
    ),
    ...
    "predator_imune_gene": mesa.visualization.Slider("Probabilidade de Imunidade aos Filhos do Lobo", 0.05, 0.0, 1.0, 0.01)
}
